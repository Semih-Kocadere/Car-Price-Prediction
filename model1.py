...
# Read dataset
cars_df = pd.read_csv("autoscout24-germany-dataset.csv")
...
features_train, features_test, target_train, target_test = train_test_split(features, targetValues, test_size=0.3)
